...
#PReNet: https://github.com/csdwren/PReNet/blob/master/networks.py
...
# M3SNet: https://github.com/Tombs98/M3SNet/blob/main/Derain/M3SNet.py
#         https://github.com/Tombs98/M3SNet/blob/main/Derain/utils/arch_utils.py
